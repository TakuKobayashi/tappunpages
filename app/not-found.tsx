  ...
  return (
    <>
      ...
      <div className="page-wrap" style={{ display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh",textAlign:"center",padding:"var(--sp6)" }}>
        <div>
          <div style={{ fontFamily:"var(--font-heading)",fontSize:"clamp(5rem,15vw,10rem)",color:"var(--yellow)",letterSpacing:"0.05em",textShadow:"4px 4px 0 rgba(0,0,0,0.2)",lineHeight:1 }}>404</div>
