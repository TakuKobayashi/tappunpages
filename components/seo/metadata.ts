...
export function buildMetadata(
  ...
  const canonical = options?.canonical ?? (locale === "en" ? `${baseUrl}/en` : baseUrl);
  ...
  return {
    ...
    keywords: [
      "Product Engineer", "Full-stack", "Android", "iOS",
      "Kotlin", "Swift", "TypeScript", "Cloudflare", "MVP",
      "Fintech", "AI", "Japan",
    ],
    ...
    openGraph: {
      ...
      images: [{ url: "/og-image.png", width: 1200, height: 630, alt: pageMeta.title }],
    },
    twitter: {
