      ...
      items: [
        {
          ...
          org: 'Independent',
          desc: '海外・スタートアップ向けMVP開発・AI統合・モバイルアプリ。Cloudflare + Next.js + Kotlin/Swift のフルスタックを一人で完結。',
        },
        {
          year: '2022–2024',
        ...
        },
        {
          ...
          org: 'Fintech Company',
          desc: '仮想通貨取引所バックエンド開発。高可用性・高セキュリティ金融系システムの設計と実装。',
        },
        {
          year: '2018–2020',
          title: 'Mobile Engineer',
          org: 'Product Company',
          desc: 'Android/iOS 両対応プロダクト開発。UX 重視の UI 実装とパフォーマンス最適化。',
        },
        {
          year: '2017',
          title: 'First Hackathon Win 🏆',
          org: 'Various events',
          desc: '複数ハッカソンで受賞。高速プロトタイピングの文化を体得。',
        },
      ],
    },
    values: {
      ...
      items: [
        {
          icon: '⚡',
          title: 'Build Fast',
          desc: '完璧を待たずに動くものを作る。最初のコミットまでを最短に。',
        },
        {
          icon: '👁',
          title: 'Show Early',
          desc: '早い段階でフィードバックを取る。仮説を最速で検証。',
        },
        {
          icon: '🔄',
          title: 'Iterate',
        ...
        },
        {
          ...
          desc: 'ゲームや趣味プロダクトも含め、常に何かを作り続ける。',
        },
        {
          icon: '🤝',
          title: 'End-to-end Ownership',
          desc: '要件定義からデプロイまで、全フェーズに責任を持つ。',
        },
      ],
    },
      ...
      items: [
        {
          ...
          title: 'Freelance Product Engineer',
          org: 'Independent',
          desc: 'MVP development, AI integration, mobile apps for overseas startups. Full-stack with Cloudflare + Next.js + Kotlin/Swift — solo.',
        },
        {
          year: '2022–2024',
          title: 'Senior Android Engineer',
        ...
        },
        {
          ...
          title: 'Full-stack Engineer',
          org: 'Fintech Company',
          desc: 'Backend development for a crypto exchange. Designed high-availability, security-critical financial systems.',
        },
        {
          year: '2018–2020',
          title: 'Mobile Engineer',
          org: 'Product Company',
          desc: 'Dual Android/iOS product development. UX-focused UI implementation and performance tuning.',
        },
        {
          year: '2017',
          title: 'First Hackathon Win 🏆',
          org: 'Various events',
          desc: 'Multiple hackathon awards. Internalized rapid prototyping culture.',
        },
      ],
    },
    values: {
      ...
      items: [
        {
          icon: '⚡',
          title: 'Build Fast',
          desc: 'Ship something working before perfecting. Minimize time to first commit.',
        },
        {
          icon: '👁',
          title: 'Show Early',
          desc: 'Get feedback fast. Validate hypotheses at maximum speed.',
        },
        {
          icon: '🔄',
          title: 'Iterate',
        ...
        },
        {
          icon: '🎮',
          title: 'Builder Mentality',
          desc: 'Always building something — games, tools, experiments.',
        },
        {
          icon: '🤝',
          title: 'End-to-end Ownership',
          desc: 'Responsible for every phase: requirements → deploy.',
        },
      ],
    },
